...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  alist = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-tAyk9g5S2c7T1lPR27Sckhck3IQaW2mB2+zJ0grs6H8=";
    };
  };
  alist-web = {
    pname = "alist-web";
    version = "3.47.1";
    src = fetchurl {
      url = "https://github.com/alist-org/alist-web/releases/download/3.47.1/dist.tar.gz";
      sha256 = "sha256-/UcG8OOpj12g0GQLKRm6fBW0eI1+PQ6oxJNJscPZOQc=";
    };
  };
  alive-progress = {
  ...
  bbdown = {
    pname = "bbdown";
    version = "675d082af9b5fcf5b39a9721fe61c30783f3ce24";
    src = fetchFromGitHub {
      owner = "nilaoda";
      repo = "BBDown";
      rev = "675d082af9b5fcf5b39a9721fe61c30783f3ce24";
      fetchSubmodules = false;
      sha256 = "sha256-tElx+DqPw/lGStu/julLED2EPXTWOT9kiIfotq+BCu4=";
    };
    date = "2025-07-01";
  };
  borders = {
  ...
  pragmasevka = {
    ...
    version = "33.2.7";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v33.2.7/pragma-sevka-mono.zip";
      sha256 = "sha256-wrn3lOKyAy4waL+rDJepWnia0ckr0X7wolQZXygp0kE=";
    };
  };
  pragmasevka-nerd = {
    ...
    version = "33.2.7";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v33.2.7/pragma-sevka-mono-nerd.zip";
      sha256 = "sha256-REgccP1eJwtul+DwROr7rbB1fbG7zRujXF0gaCeMpFc=";
    };
  };
  pragmasevka-sans = {
    ...
    version = "33.2.7";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v33.2.7/pragma-sevka-sans.zip";
      sha256 = "sha256-iv8jkW+lrcCgg5tW0bjMrTJRBoRCgGrRbmFHbBJOxOI=";
    };
  };
  pragmasevka-sc = {
    ...
    version = "33.2.7";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v33.2.7/Pragma-Sevka-SC.ttf";
      sha256 = "sha256-XUspF63I1kCL+txhhzO3grh35/AuYOXblsqIPOAC6BE=";
    };
  };
  pragmasevka-sc-nf = {
    ...
    version = "33.2.7";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v33.2.7/Pragma-Sevka-SC-NF.ttf";
      sha256 = "sha256-pY2qSqF41cZpH7el2bujJeNTXZCiIrYhrm/W3aKWOmM=";
    };
  };
  pragmasevka-serif = {
    ...
    version = "33.2.7";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v33.2.7/pragma-sevka-serif.zip";
      sha256 = "sha256-MYlG9Y2FyVf49rCvSTC1FUv2MEq19lVbgZUfTW1x8Bk=";
    };
  };
  qbittorrent = {
    pname = "qbittorrent";
  ...
  rime-ice = {
    ...
    src = fetchFromGitHub {
      ...
      fetchSubmodules = false;
      sha256 = "sha256-r9fCfHVYcofTQV+/L994Efz4J/mUrAHDzKZOu2SX0B4=";
    };
    date = "2025-08-01";
  };
  sarasa-term = {
  ...
  wanxiang-lts-zh-hans = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-qozbt4HMmM1Oz0L7X64esWDjSMQ9LQDBc0qF5I/YKcA=";
    };
  };
