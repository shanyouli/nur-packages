...
}:
{
  ...
  emacs-reader = {
    pname = "emacs-reader";
    version = "9824fc91eb51bec0edb8c3634a74d73226d26525";
    src = fetchgit {
  ...
  "emacs29.no-frame-refocus-cocoa" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-28/no-frame-refocus-cocoa.patch";
  ...
  "emacs29.role-patch" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-28/fix-window-role.patch";
  ...
  "emacs29.round-undecorated-frame" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-29/round-undecorated-frame.patch";
  ...
  "emacs29.system-appearance" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-28/system-appearance.patch";
  ...
  "emacs30.ns-mac-input-source" = {
    ...
    version = "d9847653bd2fbe74591b7bbc2a589be1cff9e40a";
    src = fetchurl {
      url = "https://github.com/LuciusChen/.emacs.d/raw/d9847653bd2fbe74591b7bbc2a589be1cff9e40a/scripts/macos/patches/emacs-30/ns-alpha-background.patch";
  ...
  "emacs30.round-undecorated-frame" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-30/round-undecorated-frame.patch";
      sha256 = "sha256-dFH4D1WYQOVOagUuVdEQB3irxV+Y8dDAOKJOJXc/KHQ=";
    };
    date = "2026-04-30";
  };
  "emacs30.system-appearance" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-30/system-appearance.patch";
  ...
  "emacs31.ns-mac-input-source" = {
    ...
    version = "d9847653bd2fbe74591b7bbc2a589be1cff9e40a";
    src = fetchurl {
      url = "https://github.com/LuciusChen/.emacs.d/raw/d9847653bd2fbe74591b7bbc2a589be1cff9e40a/scripts/macos/patches/emacs-31/ns-mac-input-source.patch";
  ...
  "emacs31.round-undecorated-frame" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-31/round-undecorated-frame.patch";
  ...
  "emacs31.system-appearance" = {
    ...
    version = "7ee9128a45879d65818e68ff9ace892737833ef1";
    src = fetchurl {
      url = "https://github.com/d12frosted/homebrew-emacs-plus/raw/7ee9128a45879d65818e68ff9ace892737833ef1/patches/emacs-31/system-appearance.patch";
  ...
  musicdl = {
    pname = "musicdl";
    version = "551eddde02c3dbd30f81239aff524983c0d4c6c7";
    src = fetchFromGitHub {
      owner = "CharlesPikachu";
      repo = "musicdl";
      rev = "551eddde02c3dbd30f81239aff524983c0d4c6c7";
      fetchSubmodules = false;
      sha256 = "sha256-k0X9KvhbzggXQKp/+8CUc0t6Uu/S5ju4VRM7TV/K4yo=";
    };
    date = "20260428";
  };
  musicn = {
  ...
  openwith = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.1";
      fetchSubmodules = false;
      sha256 = "sha256-MJNTnrWO5unlQoIk4ozTkx6yNPYKO9K9hIucRPkUlnE=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./. + "/sha256-MJNTnrWO5unlQoIk4ozTkx6yNPYKO9K9hIucRPkUlnE=/Cargo.lock";
      outputHashes = {
  ...
  pragmasevka = {
    ...
    version = "34.4.0";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v34.4.0/pragma-sevka-mono.zip";
      sha256 = "sha256-KoY578DD+cl6sdSbsIlq6eQVh2tL/OHcYShvk1+0EdQ=";
    };
  };
  pragmasevka-nerd = {
    ...
    version = "34.4.0";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v34.4.0/pragma-sevka-mono-nerd.zip";
      sha256 = "sha256-MKJIHhyZ6PIZYwhI1iQXq5e2H0R/lwJoS5fBxCr7BEg=";
    };
  };
  pragmasevka-sans = {
    ...
    version = "34.4.0";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v34.4.0/pragma-sevka-sans.zip";
      sha256 = "sha256-0n0fIqNAFA0DWLzzNKD8wK71vtaVale/c3HxGx+hBS4=";
    };
  };
  pragmasevka-sc = {
    ...
    version = "34.4.0";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v34.4.0/Pragma-Sevka-SC-Regular.ttf";
      sha256 = "sha256-CKY+CNMiHkoUV+Aa9E46MIwxEEdk865p/WgfaMiLufA=";
    };
  };
  pragmasevka-sc-nf = {
    ...
    version = "34.4.0";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v34.4.0/Pragma-Sevka-SC-NF-Regular.ttf";
      sha256 = "sha256-uC6R2Nuj7sCS5FchzXQ4aDkSHFqXHg+GnD4hxlusecw=";
    };
  };
  pragmasevka-serif = {
    ...
    version = "34.4.0";
    src = fetchurl {
      url = "https://github.com/shanyouli/iosevka/releases/download/v34.4.0/pragma-sevka-serif.zip";
      sha256 = "sha256-6kh4fEUZOgay1bOKLamNTdGmxy0AKQnwja2rPVuOYlw=";
    };
  };
  pyfreeproxy = {
    pname = "pyfreeproxy";
    version = "c2d5103b7da310b54542bdda36ad30d7a1885c4d";
    src = fetchFromGitHub {
      owner = "CharlesPikachu";
      repo = "freeproxy";
      rev = "c2d5103b7da310b54542bdda36ad30d7a1885c4d";
      fetchSubmodules = false;
      sha256 = "sha256-TIQr1lAUA8B8KzSKHjeF7X+wCXplcWHsebWcl5HR8TA=";
    };
    date = "20260430";
  };
  rime-ice = {
    ...
    src = fetchFromGitHub {
      ...
      fetchSubmodules = false;
      sha256 = "sha256-IexNxCENmeu7wXYuCFQ2FgIomm8x9+ahEGTzzpGBmvI=";
    };
    date = "20260427";
  };
  sarasa-term = {
