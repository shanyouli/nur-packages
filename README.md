...
- LAST_MODIFY: 2025-05-30 22:51:59 UTC
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20250530.0|Extensible, customizable GNU text editor|
...
|[**nh**](https://github.com/nix-community/nh)||4.1.0-1ea27e7|Yet another nix cli helper|
|[**nix-index**](None)|||None|
...
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||unstable-2025-05-29|Rime 配置:雾凇拼音|
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||6.8.8|Rime 配置:万象输入法|
...
|[**download-with-aria2**](https://github.com/jc3213/download_with_aria2)||4.16.1.3418|Browser extension for aria2c json-rpc |
