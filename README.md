...
- LAST_MODIFY: 2026-08-16 07:47:46 UTC
...
|[**cc-switch**](https://github.com/saladday/cc-switch-cli)||5.9.3|CLI manager for Claude Code, Codex, Gemini, OpenCode, and OpenClaw|
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20260731.0|Extensible, customizable GNU text editor|
|[**emacs**](https://www.gnu.org/software/emacs/)||20260730.0|Extensible, customizable GNU text editor|
...
|[**jcode**](https://github.com/1jehuang/jcode)||0.64.2|Coding Agent Harness|
...
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||9.9.20260731|Rime 配置:雾凇拼音|
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||v16.4.2|Rime 配置:万象输入法|
...
|[**userChromeJS**](https://github.com/benzBrake/userChrome.js-Loader)||20260731|Firefox scripts |
...
|[**styl-us**](https://add0n.com/stylus.html)||2.4.8|Stylus - Userstyles Manager|
...
|[**violentmonkey**](https://violentmonkey.github.io)||2.46.0|An open source userscript manager.|
...
|[**musicdl**](https://github.com/CharlesPikachu/musicdl)||20260730|A lightweight music downloader written in pure python.|
|[**pyfreeproxy**](https://github.com/CharlesPikachu/freeproxy)||20260731|FreeProxy: Collecting free proxies from internet|
