...
- LAST_MODIFY: 2026-09-12 03:45:42 UTC
...
|:---|:---|:---|:---|
|[**bash-env-json**](https://github.com/tesujimath/bash-env-json)||0.11.0| export of Bash environment as JSON|
|[**cc-switch**](https://github.com/saladday/cc-switch-cli)||5.10.4|CLI manager for Claude Code, Codex, Gemini, OpenCode, and OpenClaw|
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20260910.0|Extensible, customizable GNU text editor|
...
|[**flexfox**](https://github.com/yuuqilin/FlexFox)||7.0.0|Firefox Chrome css|
|[**jcode**](https://github.com/1jehuang/jcode)||0.84.0|Coding Agent Harness|
...
|[**pragmasevka-sc**](https://github.com/shanyouli/iosevka)||34.8.0|我的自定义 iosvake, 使用 LXGW-wenKai 作为中文字体|
|[**pragmasevka-sc-nf**](https://github.com/shanyouli/iosevka)||34.8.0|我的自定义 iosvake, 使用 LXGW-wenKai 作为中文字体|
...
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||9.9.20260910|Rime 配置:雾凇拼音|
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||v17.9.9|Rime 配置:万象输入法|
...
|[**tmux-fastcopy**](https://github.com/abhinav/tmux-fastcopy/tree/main)||0.15.0|easymotion-style text copying for tmux.|
|[**userChromeJS**](https://github.com/benzBrake/userChrome.js-Loader)||20260906|Firefox scripts |
...
|[**firefox-esr**](http://www.mozilla.com/en-US/firefox/)||140.15.0esr|Mozilla Firefox, free web browser (binary package)|
...
|[**openwith**](https://github.com/ColeMei/openwith)||0.6.1|Manage macOS file extension associations from the terminal |
...
|[**darkreader**](https://darkreader.org/)||4.9.130|Dark Reader Chrome and Firefox extension|
...
|[**kiss-translator**](https://github.com/fishjar/kiss-translator)||2.0.32|Simple, open source bilingual translation extension & Greasemonkey script|
|[**noscript**](https://noscript.net/)||13.6.32|NoScript Security Suite|
...
|[**user-agent-string-switcher**](https://add0n.com/useragent-switcher.html)||0.7.1|User-Agent Switcher and Manager|
|[**violentmonkey**](https://violentmonkey.github.io)||2.49.0|An open source userscript manager.|
|[**zeroomega**](https://github.com/zero-peak/ZeroOmega)||3.5.1| Manage and switch between multiple proxies quickly & easily.|
</details>
...
|[**musicdl**](https://github.com/CharlesPikachu/musicdl)||20260910|A lightweight music downloader written in pure python.|
|[**pyfreeproxy**](https://github.com/CharlesPikachu/freeproxy)||20260911|FreeProxy: Collecting free proxies from internet|
