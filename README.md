...
- LAST_MODIFY: 2026-05-30 12:05:56 UTC
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20260525.0|Extensible, customizable GNU text editor|
|[**emacs**](https://www.gnu.org/software/emacs/)||20260524.0|Extensible, customizable GNU text editor|
...
|[**jcode**](https://github.com/1jehuang/jcode)||0.15.0|Coding Agent Harness|
...
|[**nix-index**](None)|||None|
|[**nu-lint**](https://github.com/wvhulle/nu-lint)||20260502|Linter for Nu shell scripts that helpfully suggests improvements|
...
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||9.9.20260523|Rime 配置:雾凇拼音|
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||v15.11.2|Rime 配置:万象输入法|
...
|[**styl-us**](https://add0n.com/stylus.html)||2.3.29.24|Stylus - Userstyles Manager|
...
|[**violentmonkey**](https://violentmonkey.github.io)||2.40.0|An open source userscript manager.|
...
|[**musicdl**](https://github.com/CharlesPikachu/musicdl)||20260530|A lightweight music downloader written in pure python.|
|[**pyfreeproxy**](https://github.com/CharlesPikachu/freeproxy)||20260529|FreeProxy: Collecting free proxies from internet|
