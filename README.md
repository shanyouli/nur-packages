...
- LAST_MODIFY: 2026-06-06 08:18:45 UTC
...
|[**cc-switch**](https://github.com/saladday/cc-switch-cli)||5.7.0|CLI manager for Claude Code, Codex, Gemini, OpenCode, and OpenClaw|
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20260605.0|Extensible, customizable GNU text editor|
|[**emacs**](https://www.gnu.org/software/emacs/)||20260528.0|Extensible, customizable GNU text editor|
...
|[**flexfox**](https://github.com/yuuqilin/FlexFox)||6.5.1|Firefox Chrome css|
|[**jcode**](https://github.com/1jehuang/jcode)||0.23.0|Coding Agent Harness|
...
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||9.9.20260603|Rime 配置:雾凇拼音|
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||v15.12.5|Rime 配置:万象输入法|
...
|[**darkreader**](https://darkreader.org/)||4.9.126|Dark Reader Chrome and Firefox extension|
...
|[**kiss-translator**](https://github.com/fishjar/kiss-translator)||2.0.22|Simple, open source bilingual translation extension & Greasemonkey script|
...
|[**musicdl**](https://github.com/CharlesPikachu/musicdl)||20260603|A lightweight music downloader written in pure python.|
|[**pyfreeproxy**](https://github.com/CharlesPikachu/freeproxy)||20260606|FreeProxy: Collecting free proxies from internet|
