...
- LAST_MODIFY: 2025-07-25 22:12:26 UTC
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20250725.0|Extensible, customizable GNU text editor|
...
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||unstable-2025-07-24|Rime 配置:雾凇拼音|
|[**moqi**](https://github.com/amzxyz/rime_wanxiang_pro)||v10.0.3|Rime 配置:万象输入法|
...
|[**firefox-esr**](http://www.mozilla.com/en-US/firefox/)||128.13.0esr|Mozilla Firefox, free web browser (binary package)|
...
|[**kiss-translator**](https://github.com/fishjar/kiss-translator)||1.9.1|Simple, open source bilingual translation extension & Greasemonkey script|
