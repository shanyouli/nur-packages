...
- LAST_MODIFY: 2026-06-12 23:31:55 UTC
...
|[**cc-switch**](https://github.com/saladday/cc-switch-cli)||5.8.2|CLI manager for Claude Code, Codex, Gemini, OpenCode, and OpenClaw|
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20260612.0|Extensible, customizable GNU text editor|
|[**emacs**](https://www.gnu.org/software/emacs/)||20260609.0|Extensible, customizable GNU text editor|
...
|[**emacs**](https://www.gnu.org/software/emacs/)||31.0.90|Extensible, customizable GNU text editor|
...
|[**flexfox**](https://github.com/yuuqilin/FlexFox)||6.5.2|Firefox Chrome css|
|[**jcode**](https://github.com/1jehuang/jcode)||0.26.0|Coding Agent Harness|
...
|[**nix-index**](None)|||None|
|[**nu-lint**](https://github.com/wvhulle/nu-lint)||20260602|Linter for Nu shell scripts that helpfully suggests improvements|
|[**pragmasevka**](https://github.com/shanyouli/iosevka)||34.6.1|我的自定义 iosvake|
|[**pragmasevka-nerd**](https://github.com/shanyouli/iosevka)||34.6.1|我的自定义 iosvake|
|[**pragmasevka-sans**](https://github.com/shanyouli/iosevka)||34.6.1|我的自定义 iosvake|
|[**pragmasevka-sc**](https://github.com/shanyouli/iosevka)||34.6.1|我的自定义 iosvake, 使用 LXGW-wenKai 作为中文字体|
|[**pragmasevka-sc-nf**](https://github.com/shanyouli/iosevka)||34.6.1|我的自定义 iosvake, 使用 LXGW-wenKai 作为中文字体|
|[**pragmasevka-serif**](https://github.com/shanyouli/iosevka)||34.6.1|我的自定义 iosvake|
|[**rime-frost**](https://github.com/gaboolic/rime-frost)||1.0.4|Rime 配置:白霜拼音|
|[**rime-ice**](https://dvel.me/posts/rime-ice/)||9.9.20260610|Rime 配置:雾凇拼音|
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||v15.14.2|Rime 配置:万象输入法|
...
|[**openwith**](https://github.com/ColeMei/openwith)||0.3.2|Manage macOS file extension associations from the terminal |
...
|[**chrome-mask**](https://github.com/denschub/chrome-mask)||9.0.0|Makes Firefox wear a mask to look like Chrome.|
|[**darkreader**](https://darkreader.org/)||4.9.127|Dark Reader Chrome and Firefox extension|
|[**download-with-aria2**](https://github.com/jc3213/download_with_aria2)||4.26.0.4164|Browser extension for aria2c json-rpc |
...
|[**kiss-translator**](https://github.com/fishjar/kiss-translator)||2.0.23|Simple, open source bilingual translation extension & Greasemonkey script|
|[**noscript**](https://noscript.net/)||13.6.23|NoScript Security Suite|
...
|[**styl-us**](https://add0n.com/stylus.html)||2.3.30|Stylus - Userstyles Manager|
...
|[**ublock-origin**](https://github.com/gorhill/uBlock)||1.71.0|uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean. |
|[**user-agent-string-switcher**](https://add0n.com/useragent-switcher.html)||0.6.7|User-Agent Switcher and Manager|
|[**violentmonkey**](https://violentmonkey.github.io)||2.41.0|An open source userscript manager.|
...
|[**musicdl**](https://github.com/CharlesPikachu/musicdl)||20260612|A lightweight music downloader written in pure python.|
|[**pyfreeproxy**](https://github.com/CharlesPikachu/freeproxy)||20260612|FreeProxy: Collecting free proxies from internet|
