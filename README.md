...
- LAST_MODIFY: 2025-05-29 10:06:40 UTC
...
|[**emacs**](https://www.gnu.org/software/emacs/)||20250523.0|Extensible, customizable GNU text editor|
...
|[**nh**](https://github.com/nix-community/nh)||4.1.0-24c1222|Yet another nix cli helper|
|[**nix-index**](None)|||None|
...
|[**rime-wanxiang**](https://github.com/amzxyz/rime_wanxiang_pro)||6.8.6|Rime 配置:万象输入法|
...
|[**firefox-esr**](http://www.mozilla.com/en-US/firefox/)||128.10.1esr|Mozilla Firefox, free web browser (binary package)|
...
|[**download-with-aria2**](https://github.com/jc3213/download_with_aria2)||4.16.0.3402|Browser extension for aria2c json-rpc |
...
|[**noscript**](https://noscript.net/)||13.0.6|NoScript Security Suite|
